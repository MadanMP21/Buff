...
`timescale 1 ns / 1 ps
	...
	(
        ...
        input wire [C_M_AXI_ADDR_WIDTH-1 : 0] Addr1,
        input wire [C_M_AXI_ADDR_WIDTH-1 : 0] Addr2,
        input wire [C_M_AXI_DATA_WIDTH-1 : 0] Data_in,
        input wire push_ready,
        output wire push_valid,
        output wire [C_M_AXI_DATA_WIDTH-1 : 0] push_data,
    ...
    reg     axi_push_valid;    
    reg [C_M_AXI_DATA_WIDTH-1 : 0] 	axi_push_data;

	// I/O Connections assignments
    assign push_data = axi_push_data;
    assign push_valid = axi_push_valid;
	...
	//case of differing reset latencies between master/slave.
      ...
      begin
          ...
          begin    
              if (axi_rready && M_AXI_RVALID && ~axi_push_valid)
              begin
	      ...
	      begin                                                                       
	       // state transition                                                          
	        case (mst_exec_state)                                                       
	          ...
	          //IDLE : mst_exec_state = (start_read_delay) ? INIT_READ : ((start_write_delay) ? INIT_WRITE : IDLE);
	           if ( init_txn_pulse == 1'b0 )                                     
	              begin    
	              ...
	              else if(start_read_delay) begin
